...
export const getLongLivedAccessToken =  (accessToken: string) => {
  ...
  // console.log('getLongLivedAccessToken URL ',URL)
  const ret = axios
    .get(URL)
    .then(async (response: AxiosResponse) => {
  // console.log('getLongLivedAccessToken response.data ',response.data)
...
export const sendMessage = async (
  ...
  try {
    const messageData = await makeMessageObject(organizationId,customer, message)
